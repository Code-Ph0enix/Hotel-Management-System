...
public class Hotel
{
    ...
    public static void CustDetails(int i,int rn)
    {
        ...
        String gender2="";
        System.out.print("InEnter customer name: ");
        name=sc.next();
        ...
        if(i<3)
        {
            ...
            name2=sc.next();System.out.print("Enter contact number: ");
            contact2=sc.next();
            System.out.print("Enter gender: ");
            gender2 =sc.next();
        }
    ...
    public static void bookroom(int i)
    {
        ...
        switch (i)
        {
            case 1:
                ...
                System.out.print("/nEnter room number: ");
                try
                {
                    rn=sc.nextInt();
                    rn--;
            ...
            case 2:
                ...
                System.out.print("InEnter room number: ");
                try
                {
                    rn=sc.nextInt();
                    rn=rn-11;
    ...
    public static void availability(int i)
    {
        ...
        switch (1)
        {
            ...
            case 3:
                ...
                break;
            default:
                System.out.println("Enter valld option");
                break;
        }
    ...
    public static void bill(int rn,int rtype)
    {
        ...
        switch(rtype)
        {
            case 1:
                ...
                {
                    amount+=obb.price;
                    System.out.printf(list[obb.itemno-1],obb.quantity,obb.price);
                }
                break;
            case 2:
                amount+=3000;
        ...
        System.out.println("InTotal Amount- "+amount);
    }
    public static void deallocate(int rn,int rtype)
    {
        ...
        switch (rtype)
        {
            case 1:
                ...
                {
                    System.out.println("Empty Aready");
                    return;
                }
    ...
    public static void order(int rn,int rtype)
    {
            ...
            do
            {
                ...
                switch(rtype)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3: 
                        hotel_ob.luxury_singleerrom[rn].food.add(new Food(1,q));
                        break;
                    case 4: 
        ...
        {
            System.out.println("InRoom not booked");
        }
        catch(Exception e)
        {
